...
if __name__ == '__main__':
    ...
    # Dataset
    parser.add_argument('--database_path', type=str, default='/mnt/tmp/Deepfake-speech/data/ASVspoof5/', help='Change this to user\'s full directory address of ASVspoof5 database.')
    ...
    d_label_trn,file_train = genSpoof_list(dir_meta = os.path.join(args.database_path+'ASVspoof5.train.tsv'),is_train=True,is_eval=False)
    ...
    d_label_dev,file_dev = genSpoof_list(dir_meta = os.path.join(args.database_path+'ASVspoof5.dev.track_1.tsv'),is_train=True,is_eval=False)
